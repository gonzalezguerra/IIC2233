...
class Corredor(Thread):
    ...
    def avanzar(self) -> None:
        # Completar
        porcentaje_avance = (randint(self.PORCENTAJE_MIN, self.PORCENTAJE_MAX) / 100)
        self.posicion += (porcentaje_avance * self.velocidad)
    ...
    def robar_tortuga(self) -> bool:
        ...
        if random() < self.PROBABILIDAD_ROBAR:
            ...
            self.tiene_tortuga = not self.tiene_tortuga
...
class Carrera(Thread):
    ...
    def empezar(self) -> str:
        ...
        if self.corredor_2.tiene_tortuga:
