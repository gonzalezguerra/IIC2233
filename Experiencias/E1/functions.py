...
def buscar_archivo(carpeta: dict, nombre_archivo: str) -> list:
    ...
    if carpeta["subcarpeta_1"]:
        iter_sub_1 = buscar_archivo(carpeta["subcarpeta_1"], nombre_archivo)

        if iter_sub_1:
            return [carpeta["nombre_carpeta"]] + iter_sub_1
    
    if carpeta["subcarpeta_2"]:
        iter_sub_2 = buscar_archivo(carpeta["subcarpeta_2"], nombre_archivo)

        if iter_sub_2:
            return [carpeta["nombre_carpeta"]] + iter_sub_2
